...
from analysis.interfaces.controllers.analysis_scope_controller import get_analysis_scope_controller
...
urlpatterns = [
    ...
    path("<slug:id>/scope", get_analysis_scope_controller, name="get_analysis_scope"),
]
