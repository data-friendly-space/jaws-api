...
from user_management.interfaces.controllers.get_workspace_users_controller import (
...
urlpatterns = [
    ...
    path(
        "<str:workspace_id>/users",
        get_workspace_users_controller,
        name="get-workspaces-users-by-workspace-id",
    ),
    path("<str:workspace_id>/analyses", get_analysis_controller, name="get_analyses"),
    path(
        "user/<slug:user_id>",
        get_workspace_by_user_id_controller,
        name="get-workspaces-by-user-id",
    ),
]
